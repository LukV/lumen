...
from lumen.cell import Cell, CellResult
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "sql": {
                "type": "string",
                "description": (
                    "A single SQL SELECT statement. Must be read-only. "
...
def build_system_prompt(
    ...
    parts = [
        ...
        "",
        "## Rules",
        f"1. Write a single {'DuckDB' if dialect == 'duckdb' else 'Postgres'} SELECT statement. "
        ...
        "10. If the question is clearly unrelated to the available data (e.g. general knowledge, math, "
        ...
        "11. When the user asks about the dataset, a table, the data model, or what questions are possible "
